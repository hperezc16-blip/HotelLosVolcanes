const ERRORES = [
  ...
  {
    id: "E-03",
    titulo: "Referencias de Claude en commits y PRs",
    categoria: "Control de Versiones",
    color: "bg-purple-50 border-purple-300 text-purple-900",
    badge: "bg-purple-100 text-purple-700",
    sintoma: '30 commits en el historial de git contenían "Co-Authored-By: Claude Sonnet 4.6 <noreply@anthropic.com>". El PR #1 tenía "Generated with Claude Code" en el cuerpo. Requerimiento del proyecto: ninguna referencia externa en el repositorio.',
    causa: 'Comportamiento por defecto del asistente de desarrollo: añade co-autoría en commits y marca los PRs. No existía configuración de atribución en el proyecto.',
    solucion: '1) Reescribir historial de git con filter-branch para eliminar las líneas Co-Authored-By. 2) Limpiar el cuerpo del PR con gh pr edit. 3) Crear .claude/settings.json con atribución vacía para prevenir recurrencia.',
    archivos: [".claude/settings.json (nuevo)", "Historial de git reescrito con force push"],
    antes: 'Co-Authored-By: Claude Sonnet 4.6 <noreply@anthropic.com>',
    despues: '# .claude/settings.json\n{ "attribution": { "commit": "", "pr": "" } }',
    leccion: "Configurar la atribución desde el inicio del proyecto. El historial de git es inmutable en la práctica — reescribirlo requiere force push y afecta a todos los colaboradores.",
  },
  {
    id: "E-04",
  ...
  },
  {
    ...
    sintoma: 'Al intentar mergear un Pull Request, un hook pre-commit/pre-push rechazaba la operación verificando si quedaban referencias a herramientas externas en el código.',
    causa: 'El cuerpo del PR todavía contenía el texto "Generated with Claude Code" en el footer. El hook estaba configurado para detectar este patrón y bloquear el merge.',
    solucion: 'Dos pasos: 1) Limpiar el cuerpo del PR con "gh pr edit 1 --body ..." eliminando el footer. 2) Crear .claude/settings.json en la raíz del proyecto para que el hook reconociera la configuración de atribución vacía.',
    archivos: [".claude/settings.json", "PR #1 (cuerpo actualizado)"],
    antes: '# PR body terminaba con:\nGenerated with Claude Code',
    despues: '# PR body limpio\n# .claude/settings.json presente con attribution vacía',
